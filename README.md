...
1. Find and replace all instances of `Gunner_Down` with the mod's name.
2. Find and replace all instances of `GunnerDown` with the mod's name *and no spaces*.
   - This should be the name of the repository on GitHub.
3. Find and replace all instances of `GunnerDown` with the mod's prefix.
   - This should be all lowercase.
4. Find and replace all instances of `GnD` with the mod's acronym.
...
## License
Gunner_Down is licensed under [APL-ND](./LICENSE.md).
